# -*- mode: makefile-gmake -*-
SLEPC_DIR=/home/rees/lsa/notebook/venv/lib/python3.8/site-packages/slepc
PETSC_DIR=/home/rees/lsa/notebook/venv/lib/python3.8/site-packages/petsc
PETSC_ARCH=
...
SLEPC_COMPILE.c = $(call quiet,$(cc_name)) -c $(PCC_FLAGS) $(PFLAGS) $(CCPPFLAGS) $(SLEPC_CC_INCLUDES) $(C_DEPFLAGS)
...
ifdef search
  ...
  TESTTARGETS := $(shell $(PYTHON) $(PETSCCONFIGDIR)/query_tests.py --srcdir=$(SLEPC_DIR)/src --testdir=$(SLEPC_DIR)/$(PETSC_ARCH)/tests '$(query)' '$(queryval)')
...
starttime: pre-clean $(libslepcall)
